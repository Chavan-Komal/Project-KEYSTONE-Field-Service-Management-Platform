...
INSERT INTO work_orders (id, code, title, description, priority, status, customer_id, site_id, assigned_to, sla_due_at, created_at, updated_at) VALUES
    ...
    ('c2222222-cccc-2222-cccc-222222222222', 'WO-1002', 'Leaking pipe under warehouse sink', NULL, 'MEDIUM', 'NEW', '11111111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444', NULL, NOW() + INTERVAL '72 hours', NOW() - INTERVAL '1 hour', NOW() - INTERVAL '1 hour'),
...
INSERT INTO work_order_status_history (id, work_order_id, from_status, to_status, changed_by, changed_at, note) VALUES
    (gen_random_uuid(), 'c1111111-cccc-1111-cccc-111111111111', NULL, 'NEW', 'a1111111-aaaa-1111-aaaa-111111111111', NOW() - INTERVAL '4 hours', 'Raised from tenant call'),
    (gen_random_uuid(), 'c1111111-cccc-1111-cccc-111111111111', 'NEW', 'ASSIGNED', 'a1111111-aaaa-1111-aaaa-111111111111', NOW() - INTERVAL '1 hour', 'Assigned to Rahul'),
    (gen_random_uuid(), 'c2222222-cccc-2222-cccc-222222222222', NULL, 'NEW', 'a4444444-aaaa-4444-aaaa-444444444444', NOW() - INTERVAL '1 hour', 'Raised via customer portal'),
    (gen_random_uuid(), 'c3333333-cccc-3333-cccc-333333333333', NULL, 'NEW', 'a1111111-aaaa-1111-aaaa-111111111111', NOW() - INTERVAL '2 hours', NULL),
    (gen_random_uuid(), 'c3333333-cccc-3333-cccc-333333333333', 'NEW', 'ASSIGNED', 'a1111111-aaaa-1111-aaaa-111111111111', NOW() - INTERVAL '90 minutes', NULL),
    (gen_random_uuid(), 'c3333333-cccc-3333-cccc-333333333333', 'ASSIGNED', 'IN_PROGRESS', 'a2222222-aaaa-2222-aaaa-222222222222', NOW() - INTERVAL '30 minutes', 'On site now');
